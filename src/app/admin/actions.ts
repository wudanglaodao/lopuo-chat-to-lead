...
export async function updateSettingsAction(formData: FormData) {
  ...
  if (section === "style" || section === "all") {
    ...
    values.widgetAdvancedEnabled = formData.get("widgetAdvancedEnabled") === "on";
    values.widgetCustomCss = values.widgetAdvancedEnabled
      ? normalizeWidgetCustomCss(String(formData.get("widgetCustomCss") || "")) || null
      : null;
    values.widgetCustomJs = values.widgetAdvancedEnabled
      ? normalizeWidgetCustomJs(String(formData.get("widgetCustomJs") || "")) || null
      : null;
  }
