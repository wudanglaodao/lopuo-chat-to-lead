...
function getDemoAdminSite(siteId: string, customerId: string): Site {
  ...
  return {
    ...
    widgetLogoType: demoConfig.widgetLogoType,
    widgetLogoUrl: demoConfig.widgetLogoUrl,
    widgetLogoText: demoConfig.widgetLogoText,
    ...
    widgetAdvancedEnabled: demoConfig.widgetAdvancedEnabled,
    widgetCustomCss: demoConfig.widgetCustomCss,
    widgetCustomJs: demoConfig.widgetCustomJs,
