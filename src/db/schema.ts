...
export const sites = pgTable(
  "sites",
  {
    ...
    widgetLogoType: text("widget_logo_type").notNull().default("image"),
    widgetLogoUrl: text("widget_logo_url").default("https://www.lopuo.com/wp-content/themes/lopuo-theme/assets/img/lopuo-logo-black.svg?ver=0.8.14"),
    widgetLogoText: text("widget_logo_text").notNull().default("Lopuo"),
